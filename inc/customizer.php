 ...
 */
function evie_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'evie_customize_register' );
...
function evie_customize_preview_js() {
	wp_enqueue_script( 'evie-customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
